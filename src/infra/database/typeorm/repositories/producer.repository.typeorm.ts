...
import type { ProducerEntityTypeorm } from "../entities/producer.entity.typeorm";

export class ProducerRepositoryTypeorm implements IProducerRepository {
  constructor(
    private readonly producerRepository: Repository<ProducerEntityTypeorm>,
  ) {}
