...
export class EmpresaTypeorm {
  ...
  @OneToMany(() => CampanhaTypeorm, (campanha) => campanha.empresa)
...
export class CampanhaTypeorm {
  ...
  @ManyToOne(() => EmpresaTypeorm, (empresa) => empresa.campanhas, {
    eager: true,
  })
  @JoinColumn({ name: "empresa_id" })
  empresa!: EmpresaTypeorm;

  @OneToMany(() => TecnicoTypeorm, (tecnico) => tecnico.campanha)
...
export class TecnicoTypeorm {
  ...
  @ManyToOne(() => CampanhaTypeorm, (campanha) => campanha.tecnicos, {
    eager: true,
  })
...
export class ProdutorCampanhaTypeorm {
  ...
  @ManyToOne(() => ProdutorTypeorm, (produtor) => produtor.produtorCampanhas)
  @JoinColumn({ name: "produtor_id" })
  produtor!: ProdutorTypeorm;

  @ManyToOne(() => CampanhaTypeorm, (campanha) => campanha.produtorCampanhas)
  @JoinColumn({ name: "campanha_id" })
  campanha!: CampanhaTypeorm;

  @ManyToOne(() => TecnicoTypeorm, (tecnico) => tecnico.produtorCampanhas)
